...
private:
    ...
    QString JTAGNames[112] = {  "DATAMOD",          "OFFDATABUFFS",     "DATAMOD<2>",       "DATAMOD<1>",       "DATAMOD<0>",       "OSCINT<5>",        "OSCINT<4>",    "OSCINT<3>",
                                ...
                                "Ch9<3>",           "Ch9<2>",           "Ch9<1>",           "Ch8<5>",           "Ch8<4>",           "Ch8<3>",           "Ch8<2>",       "Ch8<1>",
                                "Ch7<5>",           "Ch7<4>",           "Ch7<3>",           "Ch7<2>",           "Ch7<1>",           "Ch6<5>",           "Ch6<4>",       "Ch6<3>",
                                "Ch6<2>",           "Ch6<1>",           "Ch5<5>",           "Ch5<4>",           "Ch5<3>",           "Ch5<2>",           "Ch5<1>",       "Ch4<5>",
                                "Ch4<4>",           "Ch4<3>",           "Ch4<2>",           "Ch4<1>",           "Ch3<5>",           "Ch3<4>",           "Ch3<3>",       "Ch3<2>",
                                "Ch3<1>",           "Ch2<5>",           "Ch2<4>",           "Ch2<3>",           "Ch2<2>",           "Ch2<1>",           "Ch1<5>",       "Ch1<4>",
                                "Ch1<3>",           "Ch1<2>",           "Ch1<1>",           "RFU",              "RFU",              "RFU",              "IEchannelSel", "TSTDSEL2",
                                ...
                                "SpilloverRFU<6>",  "SpilloverRFU<5>",  "SpilloverRFU<4>",  "SpilloverRFU<3>",  "SpilloverRFU<2>",  "SpilloverRFU<1>",  "OFFOSC",       "BIOPASSTHRU"};
};
