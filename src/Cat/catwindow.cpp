...
CatWindow::CatWindow(){
    ...
    thresholdTab = new ThresholdTab;
    connect(thresholdTab, SIGNAL(updateStatusBarSignal(QString)), this, SLOT(update_status_bar(QString)));
    connect(thresholdTab, SIGNAL(refreshLayoutSignal()), this, SLOT(refreshLayout()));
...
QTabWidget *CatWindow::createSettingsGroup(){
    groupSettings= new QTabWidget;

    groupSettings->addTab(thresholdTab, tr("Threshold"));

    return groupSettings;
}

//QHBoxLayout *CatWindow::createIOLayout(){
//    //add button
...
void CatWindow::update_status_bar(QString text){
    statusBarLabel->setText(text);
}

void CatWindow::refreshLayout(){
    createLayout();
}
